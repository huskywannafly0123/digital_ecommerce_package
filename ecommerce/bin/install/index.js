...
async function install() {
  ...
  const dbQuestions = [
    ...
    },
    {
      type: 'input',
      name: 'databaseName',
      message: 'Postgres Database Name (digital_ecommerce_db)',
      initial: process.env.DB_NAME || 'digital_ecommerce_db',
    ...
    },
    {
      ...
      message: 'PostgreSQL Database Password (<postgres>)',
      initial: process.env.DB_PASSWORD || 'postgres',
